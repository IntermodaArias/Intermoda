...
using Intermoda.ClientProxy.Lectura.ModuloSemanaOperarioServiceReference;

namespace Intermoda.Client.Lectura
{
    public class ModuloSemanaOperario : ObservableObject
    {
        private static ModuloSemanaOperarioClient _client;
        ...
        public static async Task<ModuloSemanaOperario> Update(ModuloSemanaOperario reg)
        {
            try
            {
                using (_client = new ModuloSemanaOperarioClient())
                {
                    ...
                    var retorno = new ModuloSemanaOperario
                    {
                        ...
                        Clasificacion = new CentroTrabajoClasificacion
                        {
                            ...
                            Tipo = GetTipo((int)model.Clasificacion.Tipo)
                        },
        ...
        public static async Task Delete(int moduloSemanaOperarioId)
        {
            try
            {
                using (_client = new ModuloSemanaOperarioClient())
                {
                    await _client.DeleteAsync(moduloSemanaOperarioId);
                }
            }
            catch (Exception exception)
            {
        ...
        public static async Task<ModuloSemanaOperario> Get(int moduloSemanaOperarioId)
        {
            try
            {
                using (_client = new ModuloSemanaOperarioClient())
                {
                    var model = await _client.GetAsync(moduloSemanaOperarioId);
        ...
        public static async Task<List<ModuloSemanaOperario>> GetByModuloSemana(int moduloSemanaId)
        {
            try
            {
                using (_client = new ModuloSemanaOperarioClient())
                {
                    var lista = await _client.GetByModuloSemanaAsync(moduloSemanaId);
        ...
        private static ClientProxy.Lectura.CentroTrabajoClasificacionServiceReference.CentroTrabajoClasificacionTipo GetTipo(int tipo)
        {
            try
            {
                return (ClientProxy.Lectura.CentroTrabajoClasificacionServiceReference.CentroTrabajoClasificacionTipo) tipo;
            }
            catch (Exception exception)
            {
                throw new Exception("ModuloSemanaOperario / GetTipo", exception);
            }
        }
