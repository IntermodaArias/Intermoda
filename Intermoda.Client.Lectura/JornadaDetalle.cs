...
using Intermoda.ClientProxy.Lectura.JornadaDetalleServiceReference;

namespace Intermoda.Client.Lectura
{
    public class JornadaDetalle : ObservableObject
    {
        private static JornadaDetalleClient _client;
        ...
        public static async Task<JornadaDetalle> Update(JornadaDetalle reg)
        {
            try
            {
                using (_client = new JornadaDetalleClient())
                {
        ...
        public static async Task Delete(int jornadaDetalleId)
        {
            try
            {
                using (_client = new JornadaDetalleClient())
                {
                    await _client.DeleteAsync(jornadaDetalleId);
                }
            }
            catch (Exception exception)
            {
        ...
        public static async Task<JornadaDetalle> Get(int jornadaDetalleId)
        {
            try
            {
                using (_client = new JornadaDetalleClient())
                {
                    var model = await _client.GetAsync(jornadaDetalleId);
        ...
        public static async Task<List<JornadaDetalle>> GetByJornada(int jornadaId)
        {
            try
            {
                using (_client = new JornadaDetalleClient())
                {
                    var lista = await _client.GetByJornadaAsync(jornadaId);
