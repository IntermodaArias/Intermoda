    ...
    public class Operacion : ObservableObject
    {
        ...
        public static async Task<Operacion> Update(Operacion operacion)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    ...
                    reg = await _client.LavanderiaOperacionUpdateAsync(reg);
        ...
        public static async Task Delete(int opeacionId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    await _client.LavanderiaOperacionDeleteAsync(opeacionId);
                }
            }
            catch (Exception exception)
            {
        ...
        public static async Task<Operacion> Get(int operacionId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var reg = await _client.LavanderiaOperacionGetAsync(operacionId);
        ...
        public static async Task<List<Operacion>> GetAll()
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var lista = await _client.LavanderiaOperacionGetAllAsync();
        ...
        public static async Task<List<Operacion>> GetAllLavanderia()
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var lista = await _client.LavanderiaOperacionGetAllLavanderiaAsync();
        ...
        public static async Task<List<Operacion>> GetOperacionesHumedas(int centroTrabajoId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var lista = await _client.LavanderiaOperacionGetHumedasAsync(centroTrabajoId);
