    ...
    public class Proceso : ObservableObject
    {
        ...
        public static async Task<Proceso> Update(Proceso proceso)
        {
            try
            {
                ...
                {
                    var reg = await _client.LavanderiaProcesoUpdateAsync(new ProcesoBusiness
                    {
                        Id = proceso.Id,
        ...
        public static async Task Delete(int procesoId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    await _client.LavanderiaProcesoDeleteAsync(procesoId);
                }
            }
            catch (Exception exception)
            {
        ...
        public static async Task<Proceso> Get(int procesoId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var reg = await _client.LavanderiaProcesoGetAsync(procesoId);
                    return new Proceso
                    {
                        Id = reg.Id,
                        Nombre = reg.Nombre,
        ...
        public static async Task<List<Proceso>> GetAll()
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var lista = await _client.LavanderiaProcesoGetAllAsync();
        ...
        public static async Task<List<Proceso>> GetByCentroTrabajo(int centroTrabajoId)
        {
            try
            {
                using (_client = new DataServiceClient())
                {
                    var lista = await _client.LavanderiaProcesoGetByCentroTrabajoAsync(centroTrabajoId);
