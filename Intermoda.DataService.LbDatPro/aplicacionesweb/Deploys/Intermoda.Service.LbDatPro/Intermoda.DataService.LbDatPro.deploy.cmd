...
set _DeploySetParametersFile=%RootPath%Intermoda.DataService.LbDatPro.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Intermoda.DataService.LbDatPro.zip" (
echo "%RootPath%Intermoda.DataService.LbDatPro.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Intermoda.DataService.LbDatPro.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Intermoda.DataService.LbDatPro.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Intermoda.DataService.LbDatPro.deploy-readme.txt" (
...
start notepad "%RootPath%Intermoda.DataService.LbDatPro.deploy-readme.txt"
)
echo =========================================================
goto :eof
