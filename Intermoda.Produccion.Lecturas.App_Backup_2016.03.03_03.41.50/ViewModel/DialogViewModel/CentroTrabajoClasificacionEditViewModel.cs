...
using CentroTrabajoClasificacionTipo = Intermoda.Produccion.Lecturas.ClientProxy.DataServiceReference.CentroTrabajoClasificacionTipo;
...
namespace Intermoda.Produccion.Lecturas.App.ViewModel
{
    public class CentroTrabajoClasificacionEditViewModel : ViewModelBase
    {
        ...
        public CentroTrabajoClasificacionEditViewModel(IDataService dataService, IDialogService dialogService, CentroTrabajoClasificacion centroTrabajoClasificacion)
        {
            ...
            if (IsInDesignMode)
            {
                ...
                _centroTrabajoClasificacion = new CentroTrabajoClasificacion
                {
                    ...
                    Tipo = (CentroTrabajoClasificacionTipo)Tipo
                };
        ...
        private void Confirm()
        {
            ...
            _centroTrabajoClasificacion.Tipo = (CentroTrabajoClasificacionTipo)Tipo;
