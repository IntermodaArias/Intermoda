...
using le = Intermoda.Client.Lectura;
...
namespace Intermoda.DataServices
{
    public class DesignDataService : IDataService
    {
        ...
        public void CentroTrabajoUpdate(le.CentroTrabajo centroTrabajo, Action<le.CentroTrabajo, Exception> action)
        {
        ...
        public void CentroTrabajoGet(int centroTrabajoId, Action<le.CentroTrabajo, Exception> action)
        {
            throw new NotImplementedException();
        }

        public void CentroTrabajoGetAll(Action<List<le.CentroTrabajo>, Exception> action)
        {
            var lista = new List<le.CentroTrabajo>();
            for (var i = 1; i < 21; i++)
            {
                lista.Add(new le.CentroTrabajo
                {
                    Id = i,
        ...
        public void CentroTrabajoGetActivos(Action<List<le.CentroTrabajo>, Exception> action)
        {
            var lista = new List<le.CentroTrabajo>();
            for (var i = 1; i < 21; i++)
            {
        ...
        public void CentroTrabajoClasificacionUpdate(le.CentroTrabajoClasificacion centroTrabajoClasificacion,
