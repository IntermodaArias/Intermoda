...
namespace Intermoda.Maquilado.Wip.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        private List<MaquiladoTeP> _lista;
        ...
        private ObservableCollection<MaquiladoTeP> _data;

        /// <summary>
        /// Sets and gets the Data property.
        /// Changes to that property's value raise the PropertyChanged event. 
        /// </summary>
        public ObservableCollection<MaquiladoTeP> Data
        {
            get
            {
                return _data;
        ...
        public MainViewModel(IDataServiceLbDatPro dataService, IDialogService dialogService)
        {
        ...
        {
            RefreshCommand = new RelayCommand(PlantaChanged);
        }
        ...
        private void LoadData()
        {
            _dataService.OrdenProduccionExternoGet(
                (list, error) =>
                {
                    ...
                    {
                        Data = new ObservableCollection<MaquiladoTeP>(
                            _lista.Where(r => r.Planta.Id == PlantaSelected.Id));
                    }
                    else
                    {
                        Data = null;
